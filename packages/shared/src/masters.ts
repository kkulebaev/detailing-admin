...
// Delete-only conflict: the master is still pinned by payment history
// (work_hours, payouts) or by bookings linked via the id-link (junction /
// responsible_id). Refused instead of cascading so the live-name booking
